...
- widescreen menu
- physical keyboard and mouse support also on Switch (re-compiled with latest SDL)
...
On Switch (USB): Mouse + keyboard tested working with "Logitech MK270 Wireless USB keyboard and mouse combo".
