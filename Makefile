...
ROMFS		:=	romfs
APP_TITLE	:=	uae3DS
APP_DESCRIPTION	:=	Commodore Amiga emulator
...
CFLAGS		:= $(ARCH) $(COMMON_CFLAGS) $(MORECFLAGS) $(INCLUDE) -std=gnu11
CXXFLAGS	:= $(ARCH) $(COMMON_CFLAGS) $(MORECFLAGS) $(INCLUDE) -fno-rtti -fpermissive -std=gnu++11
